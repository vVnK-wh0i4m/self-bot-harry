...
def print_author():
 ...
 ↦  ↦  ↦  ↦  ↦  ↦  ↦  ↦  ↦  ↦  
↧ {Fore.RED}Copyright: Harry       ↥
↧ {Fore.BLUE}Discord: Akinadeptrai        ↥
↧ {Fore.GREEN}Instagram: Not            ↥
...
async def main():
    ...
    logging.info(f"\n{Style.BRIGHT + Fore.MAGENTA}RUN BY SLEEPLYLESS⚡\n")
